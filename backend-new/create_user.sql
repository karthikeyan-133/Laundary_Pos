...
CREATE DATABASE IF NOT EXISTS Pos_Techzon CHARACTER SET UTF8MB4;

CREATE USER IF NOT EXISTS 'Pos_User'@'techzondb.webby.one' IDENTIFIED BY 'Welc0me$27';

GRANT ALL PRIVILEGES ON Pos_system.* TO 'Pos_User'@'techzondb.webby.one';
